...
class GroupMail(Helper):
    ...
    def click_on_new_group(self):
        ...
        self.contact_window.child_window(title="New Contact Group", control_type="Button").click_input()
        self.logger.info("Clicked on New Contact Group button")
    ...
    def select_members(self):
        self.select_member_dlg = self.new_contact_grp_dlg.child_window(title_re=".*Select Members: Global Address List.*", control_type="Window")
